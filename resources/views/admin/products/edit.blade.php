            ...
            <form method="POST" action="{{ route('admin.products.update', $product) }}" enctype="multipart/form-data" class="space-y-4">
                    ...
                    <div>
                        ...
                        <select id="series_id" name="series_id" class="block mt-1 w-full rounded-md border-gray-300" required>
                            @foreach ($allSeries as $item)
                                <option value="{{ $item->id }}" {{ old('series_id', $product->series_id) == $item->id ? 'selected' : '' }}>{{ $item->name }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                ...
                <div class="border-t border-gray-100 pt-4">
                    ...
                    <div class="mt-3">
                        ...
                        <x-text-input id="featured_tagline" name="featured_tagline" class="block mt-1 w-full" :value="old('featured_tagline', $product->featured_tagline)" maxlength="160" />
